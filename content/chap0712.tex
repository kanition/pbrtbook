...
\begin{theorem}
    ...
    即对于\keyindex{可积函数}{integrable function}{}$f$，它可以采样出$t=\tau$处的值：
    \begin{align}
...
\end{align}
\subsubsection*{单位常函数}
定义\keyindex{双边指数衰减函数}{two-sided decaying exponential function}{}
\sidenote{属于\keyindex{拉普拉斯分布}{Laplace distribution}{distribution分布}。}为
\begin{align}
