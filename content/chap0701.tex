...
约瑟夫·傅里叶\begin{marginfigure}
    \includegraphics[width=\linewidth]{chap07/FourierRestoration.jpg}
\end{marginfigure}\sidenote{译者注：法国数学与物理学家
    让·巴蒂斯特·约瑟夫·傅里叶(Jean-Baptiste Joseph Fourier, 1768-1830)。
    其中文译名也作“傅立叶”。}首先描述了这一奇特事实，
傅里叶变换即将函数转换为该表示。
...
\begin{marginfigure}
    \includegraphics[width=\linewidth]{chap07/HarryNyquist.jpg}
\end{marginfigure}\sidenote{译者注：瑞典裔美国物理学家哈里·奈奎斯特(Harry Nyquist, 1889-1976)。}。
