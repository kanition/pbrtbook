...
此时$s_i<0$，像点$F_i$在顶点的左边；类似地，当入射光线是汇聚时我们称物是虚的
（\reffig{6.33.2}），此时$s_o<0$，物点$F_o$在顶点右边。
\begin{figure}[htbp]
    \centering
    \subfloat[虚像点]{\includegraphics[width=0.5\linewidth]{chap06/VirtualImagePoint.eps}\label{fig:6.33.1}}\,\,\,
