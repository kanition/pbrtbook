...
\begin{definition}
    曲面$\bm r=\bm r(u,v)$的\keyindex{第一基本形式}{the first fundamental form}{}：
...
\end{align}
于是我们得到$\bm r_1,\bm r_2$和$\bm n$的导向量为
\begin{theorem}
    \begin{align}\label{eq:03ex01.35}
        ...
        \end{array}\right.\quad i,j=1,2\, ,
    \end{align}
    上式称为\keyindex{曲面的基本方程}{}{}，
    其中第一式称为\keyindex{高斯方程}{Gauss equation}{}，
    第二式子称为\keyindex{Weingarten方程}{Weingarten equation}{}，
    系数
...
\begin{notation}
    将曲面的基本方程中的系数用旧记号表示得
    \begin{align*}
        E_u              & =\frac{\partial E}{\partial u},      &
        E_v              & =\frac{\partial E}{\partial v},        \\
        F_u              & =\frac{\partial F}{\partial u},      &
        F_v              & =\frac{\partial F}{\partial v},        \\
        G_u              & =\frac{\partial G}{\partial u},      &
        G_v              & =\frac{\partial G}{\partial v},        \\
