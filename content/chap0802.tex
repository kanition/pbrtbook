...
\keyindex{菲涅耳方程}{Fresnel equations}{}\begin{marginfigure}
    \includegraphics[width=\linewidth]{chap08/AugustinFresnel.jpg}
\end{marginfigure}\sidenote{译者注：法国物理学家奥古斯丁·菲涅耳(Augustin-Jean Fresnel, 1788-1827)。}
描述了表面上反射光的量；它们是麦克斯韦方程在光滑表面上的解。
