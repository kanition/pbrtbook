...
\usepackage{calligra} % For "p" in calligra font
\usepackage[utf8]{inputenc} % Required for including letters with accents
\usepackage[T1]{fontenc} % Use 8-bit encoding that has 256 glyphs
% To make \epsilon differs to \varepsilon, set font cambria.ttc for \epsilon
\renewcommand{\epsilon}{\ensuremath{\textit{\fontspec{cambria.ttc}[Path=fonts/,ItalicFeatures={FakeSlant=0.18}]ϵ}}} % For \epsilon
\newcommand{\srcp}{\ensuremath{\text{\calligra p}}} % For "p" in calligra font
...
{\hypertarget{toc:section.\thecontentslabel}{}\contentslabel[\thecontentslabel]{1.25cm}} % Formatting of numbered sections of this type
...
{\hypertarget{toc:subsection.\thecontentslabel}{}\contentslabel[\thecontentslabel]{1.25cm}} % Formatting of numbered sections of this type
{} % Formatting of numberless sections of this type
...
\usepackage{esint} % for \oiint \varoiint 
\usepackage{mathrsfs}
\usepackage{yhmath}
...
\renewcommand{\section}{\@startsection{section}{1}{\z@}
    ...
    {1ex \@plus.2ex }
    {\normalfont\large\sffamily\bfseries\protect\hyperlink{toc:section.\thesection}}}
\renewcommand{\subsection}{\@startsection {subsection}{2}{\z@}
    {-3ex \@plus -0.1ex \@minus -.4ex}
    {0.5ex \@plus.2ex }
    {\normalfont\sffamily\bfseries\protect\hyperlink{toc:subsection.\thesubsection}}}
