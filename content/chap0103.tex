...
由来自\refvar{Sampler}{}的\keyindex{样本}{sample}{}
流驱动的；每个这样的样本都标识了图像上的一点，
让积分器计算到达该点以构成图像的光量。
\begin{lstlisting}
...
因此，\refvar{Sampler}{}提供了方法\refvar{Clone}{()}
来创建给定\refvar{Sampler}{}的新实例；
...
它在达到预设最大深度\refvar[maxDepth]{WhittedIntegrator::maxDepth}{}
时停止递归。默认最大递归深度为5。
...
\refvar{WhittedIntegrator}{}必须提供方法\refvar{Li}{()}
的一种实现，返回到达给定光线起点的辐亮度。
