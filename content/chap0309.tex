...
消除有效数字前导一位也能表示\keyindex{非规范化的}{denormalized}{}数：
如果总是出现前导一，则最小的32位浮点是
\begin{align*}
    1.0\ldots0_2\times2^{-127}\approx5.8774718\times10^{-39}\, .
\end{align*}
没有前导一位，最小值是
\begin{align*}
    0.00\ldots1_2\times2^{-126}=2^{-126}\times2^{-23}\approx1.4012985\times10^{-45}\, .
\end{align*}
