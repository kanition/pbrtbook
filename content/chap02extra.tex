...
于是有四元数积
\begin{align}
    \bm q\bm p\bar{\bm q} & =(c+\bm s)\bm p(c-\bm s)\nonumber                                                                                                                                                                \\
...
更一般地，对任意实数$w$有
\begin{align}
    \bm q(w+\bm p)\bar{\bm q} & =w\bm q\bar{\bm q}+\bm q\bm p\bar{\bm q}\nonumber \\
                              & =w\|\bm q\|^2+\bm q\bm p\bar{\bm q}\nonumber      \\
                              & =w+\bm q\bm p\bar{\bm q}\nonumber                 \\
                              & =w+\bm p'\, .
\end{align}
其中第一个等号运用了四元数乘法分配律。
...
\begin{proposition}
    ...
    则$\bm p'$的齐次坐标恰是四元数积$\bm q\bm p\bar{\bm q}$，其中
    \begin{align}
    ...
    \end{align}
    其中$\bm I$为单位矩阵，$\bm A_{\bm n}$为叉积的等效矩阵
    \begin{align}
        \bm A_{\bm n}=\left[
            \begin{array}{ccc}
                0    & -n_z & n_y  \\
