...
\begin{align}\displaystyle
    ...
    =&\frac{\alpha^2}{\pi\cot\theta_{\mathrm{o}}}\int_{\cot\theta_{\mathrm{o}}}^{+\infty}
    \frac{x_s-\cot\theta_{\mathrm{o}}}{(\alpha^2+x_s^2)^\frac{3}{2}}\left(\int_{-\infty}^{+\infty}
    \left(\frac{1}{1+t^2}-\frac{t^2}{(1+t^2)^2}\right)\mathrm{d}t\right)\mathrm{d}x_s\nonumber\\
    =&\frac{\alpha^2}{\pi\cot\theta_{\mathrm{o}}}\int_{\cot\theta_{\mathrm{o}}}^{+\infty}
    \frac{x_s-\cot\theta_{\mathrm{o}}}{(\alpha^2+x_s^2)^\frac{3}{2}}\left(\arctan t\bigg|_{t=-\infty}^{+\infty}-
    \int_{-\infty}^{+\infty}\frac{t}{2(1+t^2)^2}\mathrm{d}(1+t^2)\right)\mathrm{d}x_s\nonumber\\
    =&\frac{\alpha^2}{\pi\cot\theta_{\mathrm{o}}}\int_{\cot\theta_{\mathrm{o}}}^{+\infty}
    \frac{x_s-\cot\theta_{\mathrm{o}}}{(\alpha^2+x_s^2)^\frac{3}{2}}\left(\pi+
    \int_{-\infty}^{+\infty}\frac{t}{2}\mathrm{d}(1+t^2)^{-1}\right)\mathrm{d}x_s\nonumber\\
    =&\frac{\alpha^2}{\pi\cot\theta_{\mathrm{o}}}\int_{\cot\theta_{\mathrm{o}}}^{+\infty}
    \frac{x_s-\cot\theta_{\mathrm{o}}}{(\alpha^2+x_s^2)^\frac{3}{2}}\left(\pi+\frac{t}{2(1+t^2)}\bigg|_{t=-\infty}^{+\infty}
    -\int_{-\infty}^{+\infty}\frac{1}{2(1+t^2)}\mathrm{d}t\right)\mathrm{d}x_s\nonumber\\
    =&\frac{\alpha^2}{\pi\cot\theta_{\mathrm{o}}}\int_{\cot\theta_{\mathrm{o}}}^{+\infty}
    \frac{x_s-\cot\theta_{\mathrm{o}}}{(\alpha^2+x_s^2)^\frac{3}{2}}\left(\pi+0-
    \frac{\arctan t}{2}\bigg|_{t=-\infty}^{+\infty}\right)\mathrm{d}x_s\nonumber\\
    =&\frac{\alpha^2}{\pi\cot\theta_{\mathrm{o}}}\int_{\cot\theta_{\mathrm{o}}}^{+\infty}
    ...
    =&-\frac{\alpha^2}{2\cot\theta_{\mathrm{o}}}\int_{\cot\theta_{\mathrm{o}}}^{+\infty}
    \mathrm{d}(\alpha^2+x_s^2)^{-\frac{1}{2}}-\frac{1}{2}\int_{\cot\theta_{\mathrm{o}}}^{+\infty}
    \frac{\sqrt{\alpha^2+x_s^2}\mathrm{d}x_s-x_s\mathrm{d}\sqrt{\alpha^2+x_s^2}}{(\sqrt{\alpha^2+x_s^2})^2}\nonumber\\
...
\end{align}
以上两个模型中均有$a=\displaystyle\frac{1}{\alpha_{\mathrm{o}}\tan\theta_{\mathrm{o}}}$.
