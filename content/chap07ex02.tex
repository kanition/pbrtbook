...
\begin{theorem}\label{theorem:7.ex02.7}
    如果存在整数$x_1,\ldots,x_k$使得$a_1x_1+\cdots+a_kx_k=1$，则$a_1,\ldots,a_k$是互质的。
\end{theorem}
\begin{prove}
...
\begin{definition}
    ...
    \begin{align}\label{eq:7.ex02.congruent}
        a\equiv b\pmod{m}\, ,
    \end{align}
    其中$m$称为\keyindex{模}{modulus}{congruent modulo $m$\ 模$m$同余}，称\refeq{7.ex02.congruent}为模$m$的同余式；
