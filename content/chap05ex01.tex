...
例如若有两对颜色外观相同，即$A\equiv B$，$C\equiv D$，
则有$A+C\equiv B+D$，$A-C\equiv B-D$，$\alpha A\equiv \alpha B$，
即加色、减色混合的外观相同，同时扩大或缩小相同倍数$\alpha>0$的外观相同，
这里符号“$\equiv$”表示颜色互相匹配。
...
CIE在实验中使用波长分别为700nm、546.1nm、435.8nm的单色光作为三原色，
