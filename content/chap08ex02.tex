...
\begin{align}
    ...
    =-\displaystyle\frac{\left(\frac{\partial\varphi}{\partial t}\right)_x}
    {\left(\frac{\partial\varphi}{\partial x}\right)_t}
...
此时称两个波\keyindex{异相}{out-of-phase}{}$180^\circ$.
